...
=== Required modification of security policy
...
For this we need to modify default security policy in the midPoint after it first starts.
Try the command from testing section below, it will try to redirect (HTTP 302) to `/midpoint` to authenticate.
